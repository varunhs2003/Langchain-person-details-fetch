...
def main():
    print("Hello from Varun's AI Agent!")
...
"""
    prompt_template = """I have given the information {information} , I want you to tell me: 
     1- His future ambition.
      2- When he was born.
       3- What are his businesses?
       """
    info_temp = PromptTemplate(input_variables=["information"], template=prompt_template)
    
    llm = ChatAnthropic(model="claude-opus-4-6", temperature=0)
    prompt= info_temp | llm
    response = prompt.invoke(input={"information": information})
